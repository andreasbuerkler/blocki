...
namespace Blocki.DrawView
{
    public class ImageDisplay : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            NotificationCenter.Instance.AddObserver(OnImageChangedNotification, Definitions.NotificationId.ImageChanged);
        }
        ...
        private void OnImageClick(object sender, PointerPressedEventArgs e)
        {
            ...
            if ((cursorPosition.Properties.IsLeftButtonPressed) || (cursorPosition.Properties.IsRightButtonPressed))
            {
                ...
                NotificationCenter.Instance.PostNotification(Definitions.NotificationId.CursorChanged, notification);
            }
        }
        ...
        private void OnImageWheelChanged(object sender, PointerWheelEventArgs e)
        {
            ...
            NotificationCenter.Instance.PostNotification(Definitions.NotificationId.ZoomChanged, notification);
        }
